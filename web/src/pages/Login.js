...
export default function Login() {
  ...
  return (
    ...
    //   <button onClick={signInWithGoogle}> Sign In With Google </button>
        ...
        <div className="h-full bg-gradient-to-t from-gray-700 via-gray-900 to-black w-full py-16 px-4">
            <div className="flex flex-col items-center justify-center">
                <svg width={188} height={74} viewBox="0 0 188 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                  
                </svg>
                <div className="bg-white text-center shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <button aria-label="Continue with google" role="button" className="text-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10"onClick={signInWithGoogle}>
                    ...
                    {/* <button aria-label="Continue with github" role="button" className="text-center justify-center focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                    ...
                    <button aria-label="Continue with twitter" role="button" className="text-center justify-center focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
