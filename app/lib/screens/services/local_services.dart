...
class LocalServices extends StatefulWidget {
  ...
  @override
  State<LocalServices> createState() => _LocalServicesState();
}
                  ...
                  stream: (sortVehicle)
                      ...
                      : (sortManpower)
                          ? fireStore
                              ...
                              .snapshots()
                          : fireStore.collection('local_bodies').snapshots(),
                            ...
                            return Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('Agency Head : ' + dataSet['team_head']),
                                  Text('Expertise : ' + dataSet['expertise']),
                                  Text(
