...
class SdrfTeam extends StatefulWidget {
  const SdrfTeam({super.key});

  @override
  State<SdrfTeam> createState() => _SdrfTeamState();
}

class _SdrfTeamState extends State<SdrfTeam> {
                  ...
                  stream: (sortVehicle)
                      ...
                      : (sortStaff)
                          ? fireStore
                              ...
                              .snapshots()
                          : fireStore.collection('sdrf').snapshots(),
