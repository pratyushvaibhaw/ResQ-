...
class NdrfTeam extends StatefulWidget {
  const NdrfTeam({super.key});

  @override
  State<NdrfTeam> createState() => _NdrfTeamState();
}

class _NdrfTeamState extends State<NdrfTeam> {
                  ...
                  stream: (sortVehicle)
                      ...
                      : (sortStaff)
                          ? fireStore
                              ...
                              .snapshots()
                          : fireStore.collection('ndrf').snapshots(),
